...
import { homeQuery, contactEnQuery, thankYouQuery, noticeQuery, termsConditionQuery } from '@/app/api/api';
...
preload('contact', contactEnQuery)
preload('thankYou', thankYouQuery)
preload('notice', noticeQuery)
preload('termsConditions', termsConditionQuery)
